...
import { Observer, Observable, Subject, Subscriber, of } from "rxjs";
import { AbstractStarkSearchComponent, StarkGenericSearchService, StarkSearchState } from "../classes";
...
describe("controller AbstractSearchComponent", () => {
	...
	beforeEach(() => {
		...
		// FIXME Uncomment this when progressService is implemented
		// mockProgressService = UnitTestingUtils.getMockedProgressIndicatorService();
